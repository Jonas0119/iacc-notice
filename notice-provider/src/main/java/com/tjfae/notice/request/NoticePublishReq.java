...
public class NoticePublishReq implements Serializable
{
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof NoticePublishReq)) {
            return false;
        }
        final NoticePublishReq other = (NoticePublishReq)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NoticePublishReq;
    }
    ...
    public String toString() {
        return "NoticePublishReq(id=" + this.getId() + ", userId=" + this.getUserId() + ", userName=" + this.getUserName() + ", title=" + this.getTitle() + ", type=" + this.getType() + ", remark=" + this.getRemark() + ", fileUrl=" + this.getFileUrl() + ", creator=" + this.getCreator() + ", createTime=" + this.getCreateTime() + ", sceneType=" + this.getSceneType() + ", code=" + this.getCode() + ", source=" + this.getSource() + ", platform=" + this.getPlatform() + ", noticeUrl=" + this.getNoticeUrl() + ", fileName=" + this.getFileName() + ", fileHash=" + this.getFileHash() + ", sourceTag=" + this.getSourceTag() + ", creatorName=" + this.getCreatorName() + ", managerName=" + this.getManagerName() + ", managerPhone=" + this.getManagerPhone() + ", authUrl=" + this.getAuthUrl() + ", payUrl=" + this.getPayUrl() + ", status=" + this.getStatus() + ", reason=" + this.getReason() + ", updateTime=" + this.getUpdateTime() + ", publishTime=" + this.getPublishTime() + ", payType=" + this.getPayType() + ", payAmount=" + this.getPayAmount() + ", callBackUrl=" + this.getCallBackUrl() + ", payOrderId=" + this.getPayOrderId() + ", payStatus=" + this.getPayStatus() + ", payTime=" + this.getPayTime() + ", payCallbackTime=" + this.getPayCallbackTime() + ")";
    }
}
